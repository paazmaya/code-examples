...
package
{
	...
	import org.igniterealtime.xiff.data.message.AMPExtension;
	import org.igniterealtime.xiff.data.message.AMPRule;
	 ...
	 * @see https://paazmaya.fi/advanced-message-processing-feature-has-landed-to-xiff
	 */
	public class XIFFExampleAdvancedMessageProcessing extends Sprite
	{
		...
		private const RESOURCE_NAME:String = "advanced-message-processing-is-what-i-do";
		 ...
		 */
		public function XIFFExampleAdvancedMessageProcessing()
		{
      ...
      addChild(_rosterCont);
        ...
        private function messageSend():void
		{
			...
			if (txt != "")
			{
				...
				now.minutes += 2;
				var amp:AMPExtension = new AMPExtension();
				amp.rules = [
					new AMPRule(
						AMPRule.ACTION_DROP,
						AMPRule.CONDITION_EXPIRE_AT,
						DateTimeParser.dateTime2string(now)
					)
				];
