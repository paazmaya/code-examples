...
package gsexamples
{
	...
	/**
	 * An example of the usage of the BezierPlugin plugin with the random control points.
	 * @license http://creativecommons.org/licenses/by-sa/4.0/
	 * @author Juga Paazmaya
	 * @see https://paazmaya.fi
	 */
    public class BezierThroughExample extends Sprite
	{
        ...
        public function BezierThroughExample()
		{
		...
		private function bezierPoints():void
		{
			...
			TweenLite.to(_follower, 30, { bezierThrough: points, onUpdate: onBezierUpdate } );
		}
